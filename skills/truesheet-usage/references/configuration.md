...
- `avoidKeyboard: false` keeps an absolute footer pinned behind the keyboard instead of rising above it. While the keyboard is open it stops padding the scrollable and counting toward `'auto'`.
