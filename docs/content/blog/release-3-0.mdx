...
description: True Sheet 3.0 rebuilt from the ground up for React Native's New Architecture (Fabric) with native performance.
authors: [lodev09]
...
<div style={{ display: 'flex', gap: '16px', marginBottom: '24px' }}>
  <img alt="React Native True Sheet - iOS" src="/img/preview-ios.gif" width="300" />
  <img alt="React Native True Sheet - Android" src="/img/preview-android.gif" width="300" />
</div>
