...
description: Sheet Navigator — a custom React Navigation navigator for presenting bottom sheets as screens in your React Native app.
authors: [lodev09]
...
<img alt="Sheet Navigator" src="/img/guides/navigation.gif" width="300" />
