...
This is called when the detent of the sheet has changed, either by dragging or by programmatically [resizing](methods#resize) it.
...
Comes with [`PositionChangeEventPayload`](types#positionchangeeventpayload).
