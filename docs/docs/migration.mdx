...
A plugged scrollable no longer gets the bottom safe-area inset applied natively. Only keyboard handling (auto-scroll and keyboard insets) stays automatic. Pad the scroll content yourself:
