...
To further customize the dimming behavior, [`dimmedDetentIndex`](/reference/props#dimmeddetentindex) is also available. Set the [detent](/reference/props#detents) `index` at which you want the sheet to start dimming.
