...
:::tip
The [`DetentInfo`](/reference/types#detentinfo) object includes a `position` property (iOS only) that provides the Y coordinate of the sheet. This can be useful for more precise position-based animations.
:::
