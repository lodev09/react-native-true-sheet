...
Using this with [`react-navigation`](https://reactnavigation.org) can cause render issue. Check out the [reat-navigation guide](/navigation#present-during-mount) for the fix 😉.
