...
`TrueSheet` supports web platforms using [@gorhom/bottom-sheet](https://github.com/gorhom/react-native-bottom-sheet) under the hood. This allows you to use the same API across iOS, Android, and Web.
