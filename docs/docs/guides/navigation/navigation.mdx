...
The base screen (determined by `initialRouteName`) is rendered as regular content, while other screens are presented as sheets on top.
...
Wrap your app content with the sheet navigator. Use `initialRouteName` to specify which screen is the base content - other screens are presented as sheets:
...
function App() {
  return (
    <NavigationContainer>
      <Sheet.Navigator initialRouteName="Main">
        {/* Sheet screens */}
        <Sheet.Screen
          name="Details"
        ...
        />
        {/* Base screen - determined by initialRouteName */}
...
function App() {
  return (
    <NavigationContainer>
      <Sheet.Navigator initialRouteName="Root">
...
:::info
Use `initialRouteName` to specify which screen is the base. Defaults to the first screen if not specified.
:::
