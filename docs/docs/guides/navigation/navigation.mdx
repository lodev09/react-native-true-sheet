...
The first screen (`index`) renders as regular content, and subsequent screens are presented as sheets when navigated to using Expo Router's navigation methods.
