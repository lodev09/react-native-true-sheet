...
Controls whether the sheet uses page sizing behavior. When enabled, the sheet sizes itself to fit the content width on larger displays (like iPad). This is particularly useful for providing a centered, page-like appearance on tablets.
