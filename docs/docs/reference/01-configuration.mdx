...
Options for customizing scrollable behavior. Applies when the sheet contains a `ScrollView` or `FlatList` (auto-detected). See [this guide](../guides/scrolling) for more information.
