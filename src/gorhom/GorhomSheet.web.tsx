...
const GorhomSheet = forwardRef<TrueSheetRefMethods, TrueSheetProps>((props, ref) => {
  const {
    name,
    detents = [0.5, 1],
    dismissible = true,
  ...
  const bottomSheetContext = useContext(SheetContext);
...
function GorhomProvider({ children }: { children: ReactNode }) {
  return <BottomSheetModalProvider>{children}</BottomSheetModalProvider>;
}

export const GorhomRenderer: WebRenderer = {
  Sheet: GorhomSheet,
  Provider: GorhomProvider,
};
