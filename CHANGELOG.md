...
- **Android**: Fixed dim flashing, footer positioning, and sheet jumping during keyboard transitions. ([#525](https://github.com/lodev09/react-native-true-sheet/pull/525) by [@lodev09](https://github.com/lodev09))
